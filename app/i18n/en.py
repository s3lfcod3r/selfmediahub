...
STRINGS = {
    ...
    "detail.order_label": "Order",
    "detail.order_auto": "Automatic",
    "detail.order_aired": "Aired (TV)",
    "detail.order_dvd": "DVD",
    "detail.order_absolute": "Absolute",
    "detail.order_saved": "Order saved",
    ...
    "sync.phase.order": "Determining episode order ...",
