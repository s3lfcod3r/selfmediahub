...
STRINGS = {
    ...
    "fskpage.intro": "Source (Emby) vs. metadata-service suggestion. Set the desired rating and write it back (locks the field in Emby).",
    ...
    "fskpage.col.source": "Source (Emby)",
