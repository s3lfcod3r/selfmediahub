...
STRINGS = {
    ...
    "fskpage.intro": "Quelle (Emby) vs. Vorschlag der Metadatendienste. Setze die gewünschte Freigabe und schreibe sie zurück (sperrt das Feld in Emby).",
    ...
    "fskpage.col.source": "Quelle (Emby)",
