/* Inline-SVG-Icons fuers Cover-Overlay (Phase 6). Skalieren verlustfrei mit dem
   Cover (currentColor erbt die Badge-Farbe), CSP-sicher, keine externen Requests.
...
(function () {
  ...
  var ICONS = {
    ...
    audio:
      '<svg class="ov-ic" viewBox="0 0 16 16" aria-hidden="true">' +
    ...
    cc:
      '<svg class="ov-ic ov-ic-cc" viewBox="0 0 20 14" aria-hidden="true">' +
